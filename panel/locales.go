...
var translations = map[string]map[string]string{
	"en": {
		...
		"probe.check":           "Check",
		"probe.mode.tcp":        "TCP",
		"probe.mode.http":       "HTTP",
		"probe.mode.real":       "Real delay",
		"probe.testall":         "Test all",
		"probe.timeout":         "timeout",
		"probe.tooltip":         "TCP: fast connection-only probe. HTTP: full request through the tunnel. Real delay: total time including TLS handshake -- closest to what a real page load feels like.",
		...
		"creds.loadfile":        "Load from file",
		"creds.loadfile.error":  "Could not read that file.",
		"creds.submit":          "Save",
	...
	"fa": {
		...
		"probe.mode.tcp":        "TCP",
		"probe.mode.http":       "HTTP",
		"probe.mode.real":       "تأخیر واقعی",
		"probe.testall":         "بررسی همه",
		"probe.timeout":         "بی‌پاسخ",
		"probe.tooltip":         "TCP: بررسی سریع فقط برقراری اتصال. HTTP: درخواست کامل از طریق تونل. تأخیر واقعی: زمان کل شامل دست‌دهی TLS — نزدیک‌ترین حالت به تجربهٔ واقعی باز شدن یک صفحه.",
		...
		"action.error":          "عملیات ناموفق بود:",
		"action.logs":           "لاگ‌ها",
		"status.active":         "فعال",
		...
		"creds.loadfile":        "بارگذاری از فایل",
		"creds.loadfile.error":  "خواندن فایل ممکن نشد.",
		"creds.submit":          "ذخیره",
	...
	"ar": {
		...
		"table.status":          "الحالة",
		"table.flag":            "العلم",
		"probe.latency":         "زمن الاستجابة",
		"probe.check":           "فحص",
		"probe.mode.tcp":        "TCP",
		"probe.mode.http":       "HTTP",
		"probe.mode.real":       "التأخير الفعلي",
		"probe.testall":         "فحص الكل",
		"probe.timeout":         "لا استجابة",
		"probe.tooltip":         "TCP: فحص سريع لإنشاء الاتصال فقط. HTTP: طلب كامل عبر النفق. التأخير الفعلي: الوقت الكلي شاملاً مصافحة TLS — الأقرب لتجربة فتح صفحة فعلية.",
		...
		"creds.loadfile":        "تحميل من ملف",
		"creds.loadfile.error":  "تعذّرت قراءة الملف.",
		"creds.submit":          "حفظ",
	...
	"ru": {
		...
		"table.status":          "Статус",
		"table.flag":            "Флаг",
		"probe.latency":         "Задержка",
		"probe.check":           "Проверка",
		"probe.mode.tcp":        "TCP",
		"probe.mode.http":       "HTTP",
		"probe.mode.real":       "Реальная задержка",
		"probe.testall":         "Проверить все",
		"probe.timeout":         "нет ответа",
		"probe.tooltip":         "TCP: быстрая проверка только установления соединения. HTTP: полный запрос через туннель. Реальная задержка: общее время, включая TLS-рукопожатие — ближе всего к реальной загрузке страницы.",
		...
		"action.error":          "Не удалось выполнить:",
		"action.logs":           "Логи",
		...
		"creds.loadfile":        "Загрузить из файла",
		"creds.loadfile.error":  "Не удалось прочитать файл.",
	...
	"zh": {
		...
		"probe.mode.tcp":        "TCP",
		"probe.mode.http":       "HTTP",
		"probe.mode.real":       "真实延迟",
		"probe.testall":         "全部检测",
		"probe.timeout":         "无响应",
		"probe.tooltip":         "TCP：仅建立连接的快速探测。HTTP：通过隧道发送完整请求。真实延迟：包含 TLS 握手的总耗时——最接近真实打开网页的体验。",
		"table.actions":         "操作",
		...
		"creds.saved":           "已保存。",
		"creds.label":           "配置 JSON",
		"creds.loadfile":        "从文件加载",
		"creds.loadfile.error":  "无法读取该文件。",
		"creds.submit":          "保存",
